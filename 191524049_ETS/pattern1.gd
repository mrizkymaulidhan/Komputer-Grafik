...
func object1(xc, yc):
	# Lingkaran Dalam
	midpointCircle2(xc, yc, 45, 45, Color(1,0.8,0.8))
	
	#Lingkaran Luar
	midpointCircle2(xc, yc, 50, 5, Color(0,0.6,0.6))
...
func object2(x, y):
	...
	# Segitiga
	Segitiga(x, y-57, 50, 25, 25, Color(0,0.6,0.6), 0)
	...
	# Bunga4
	persegi(x-20, y-20, 40, 20, Color(1,0.6,0.2))
	midpointCircle2(x, y, 5, 5, Color(0,0.3,0.3))
	put_pixel(x,y,Color(0,0.3,0.3))
	midCircle(x, y+20, 20, 20, Color(1,0.6,0.2), 0)
	midCircle(x-20, y, 20, 20, Color(1,0.6,0.2), 90)
	midCircle(x, y-20, 20, 20, Color(1,0.6,0.2), 180)
	midCircle(x+20, y, 20, 20, Color(1,0.6,0.2), 270)
